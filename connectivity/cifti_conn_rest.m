...
CIFTITemplateA = '/net/pepper/ivy_data/TMSGaze/results/[Subject]/[Subject]/func/[Subject]_task-restdayA_[Run]_space-fsLR_den-91k_bold.dtseries.nii';
ConfoundTemplateA = '/net/pepper/ivy_data/TMSGaze/results/[Subject]/[Subject]/func/[Subject]_task-restdayA_[Run]_desc-confounds_regressors.tsv';

CIFTITemplateB = '/net/pepper/ivy_data/TMSGaze/results/[Subject]/[Subject]/func/[Subject]_task-restdayA_[Run]_space-fsLR_den-91k_bold.dtseries.nii';
ConfoundTemplateA = '/net/pepper/ivy_data/TMSGaze/results/[Subject]/[Subject]/func/[Subject]_task-restdayA_[Run]_desc-confounds_regressors.tsv';
...
corr_mat_rest = zeros(n,nroi,nroi);
stats = zeros(n,4);
errors = {};
